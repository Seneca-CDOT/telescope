...
// create a validation middleware for /query
const validateQuery = validate(queryValidationRules);
// create a validation middleware for /posts params
const validatePostsQuery = validate(validatePostsQueryRules);
